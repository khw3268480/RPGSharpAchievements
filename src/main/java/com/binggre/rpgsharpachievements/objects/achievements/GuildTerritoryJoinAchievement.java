...
public class GuildTerritoryJoinAchievement extends Achievement {

    public GuildTerritoryJoinAchievement(int level, String typeName, String objectName, int amount, String rewardGroup, String rewardCommand) {
